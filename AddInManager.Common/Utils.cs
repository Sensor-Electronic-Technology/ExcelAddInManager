...
namespace AddInManager.Common {
    public class Utils {
        ...
        public static AddInFile GetAddInInfo(string path) {
            ...
            result.CompanyName = "Sensor Electronic Technology Inc";
            ...
            /*if (result.ProductName == "Excel-DNA Add-In Framework for Microsoft Excel" &&
                result.CompanyName == "Govert van Drimmelen") {
